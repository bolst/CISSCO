...
public class ImageItem {
    ...
    private double center_lx,center_ly,center_lz;
    private double center_mx,center_my,center_mz;
    private double center_sx,center_sy,center_sz;
    ...
    */
    private String findFaultyAxis(int accuracy,
        ...
        int ix = (int)(center_sx);
        int iy = (int)(center_sy);
        int iz = (int)(center_sz);
    ...
    private void negateValues(  double[] values, 
        ...
        switch (axis) {
          case "x":
            if (direction == true) {
              for (int i = startingPoint; i < startingPoint + grid + 1; i++) {
                if (Math.abs(mag.getProcessor().getPixelValue(i, (int)(center_sy))) < maxMagValue) {
                  values[i] = 0.0;
                }
              }
              return;
          ...
          case "y":
            if (direction == true) {
              for (int i = startingPoint; i < startingPoint + grid + 1; i++) {
                if (Math.abs(mag.getProcessor().getPixelValue((int)(center_sx), i)) < maxMagValue) {
                  values[i] = 0.0;
                }
              }
              return;
          ...
          case "z":
            if (direction == true) {
              for (int i = startingPoint; i < startingPoint + grid + 1; i++) {
                mag.setSlice(i + 1);
                if (Math.abs(mag.getProcessor().getPixelValue((int)(center_sx),
                    (int)(center_sy))) < maxMagValue) {
                  values[i] = 0.0;
                }
              }
              return;
    ...
    */
    ...
    if (neglectedAxis.compareTo("x") == 0) {
      center_sx = ((nC + r1) + (nC - r2)) / 2.0;
      center_sx = Math.round(center_sx * 10.0) / 10.0;
      Calculate_Magnetic_Moment_3D.txt_rcx.setText(String.valueOf(Math.round(center_sx * 10.0) / 10.0));
    }
    if (neglectedAxis.compareTo("y") == 0) {
      center_sy = ((nC + r1) + (nC - r2)) / 2.0;
      center_sy = Math.round(center_sy * 10.0) / 10.0;
      Calculate_Magnetic_Moment_3D.txt_rcy.setText(String.valueOf(Math.round(center_sy * 10.0) / 10.0));
    }
    if (neglectedAxis.compareTo("z") == 0) {
      center_sz = ((nC + r1) + (nC - r2)) / 2.0;
      center_sz = Math.round(center_sz * 10.0) / 10.0;
      Calculate_Magnetic_Moment_3D.txt_rcz.setText(String.valueOf(Math.round(center_sz * 10.0) / 10.0));
    }
    //center_s = new String(
    //    String.valueOf(center_sx) + "," + String.valueOf(center_sy) + "," + String.valueOf(center_sz));
    ...
    */
    ...
    public double estimateRCenter(){
     ...
     double[] xPhaseValues_Positive = new double[2 * ((int)center_sx + grid + 1)];
     double[] yPhaseValues_Positive = new double[2 * ((int)center_sy + grid + 1)];
     double[] zPhaseValues_Positive = new double[2 * ((int)center_sz + grid + 1)];
     double[] xPhaseValues_Negative = new double[2 * ((int)center_sx + grid + 1)];
     double[] yPhaseValues_Negative = new double[2 * ((int)center_sy + grid + 1)];
     double[] zPhaseValues_Negative = new double[2 * ((int)center_sz + grid + 1)];
 
     // Setting slice to initial z
     phase.setSlice((int)center_sz + 1);
 
     // putting phase values into array, following respectively for other 5 loops
     for (int i = (int)center_sx; i < (int)center_sx + grid + 1; i++) {
       xPhaseValues_Positive[i] = Math.abs((double) phase.getProcessor().getPixelValue(i, (int)center_sy));
     }
     for (int i = (int)center_sx; i > (int)center_sx - grid - 1; i--) {
       xPhaseValues_Negative[i] = Math.abs((double) phase.getProcessor().getPixelValue(i, (int)center_sy));
     }
     for (int j = (int)center_sy; j < (int)center_sy + grid + 1; j++) {
       yPhaseValues_Positive[j] = Math.abs((double) phase.getProcessor().getPixelValue((int)center_sx, j));
     }
     for (int j = (int)center_sy; j > (int)center_sy - grid - 1; j--) {
       yPhaseValues_Negative[j] = Math.abs((double) phase.getProcessor().getPixelValue((int)center_sx, j));
     }
     for (int k = (int)center_sz; k < (int)center_sz + grid + 1; k++) {
       phase.setSlice(k + 1);
       zPhaseValues_Positive[k] = Math.abs((double) phase.getProcessor().getPixelValue((int)center_sx, (int)center_sy));
     }
     for (int k = (int)center_sz; k > (int)center_sz - grid - 1; k--) {
       phase.setSlice(k + 1);
       zPhaseValues_Negative[k] = Math.abs((double) phase.getProcessor().getPixelValue((int)center_sx, (int)center_sy));
     }
     ...
     negateValues(xPhaseValues_Positive, M, (int)center_sx, "x", true);
     negateValues(xPhaseValues_Negative, M, (int)center_sx, "x", false);
     negateValues(yPhaseValues_Positive, M, (int)center_sy, "y", true);
     negateValues(yPhaseValues_Negative, M, (int)center_sy, "y", false);
     negateValues(zPhaseValues_Positive, M, (int)center_sz, "z", true);
     negateValues(zPhaseValues_Negative, M, (int)center_sz, "z", false);
    ...
    public double estBkg(){
        ...
        // lbl_estBkgPhaseVal.setText(String.valueOf(Math.round(bkgPhase * 100.0) / 100.0));
    ...
    public void calcR0123(){
        double factor = Math.pow(RCenter, 3.0) * phaseValue;
         ...
         int xDistanceFromEdge1 = mag.getWidth() - 1 - (int)(center_sx);
         int xDistanceFromEdge2 = (int)(center_sx);
         int yDistanceFromEdge1 = mag.getHeight() - 1 - (int)(center_sy);
         int yDistanceFromEdge2 = (int)(center_sy);
         int zDistanceFromEdge1 = mag.getNSlices() - 1 - (int)(center_sz);
         int zDistanceFromEdge2 = (int)(center_sz);
    ...
    public void calcCenterM(){    
        // ---------- Begin to find Center_M
         ...
         center_mx = (double) (roi_mag_belowM_xi + roi_mag_belowM_xi + roi_mag_belowM_Dx);
         center_my = (double) (roi_mag_belowM_yi + roi_mag_belowM_yi + roi_mag_belowM_Dy);
         center_mz = (double) (roi_mag_belowM_zi + roi_mag_belowM_zi + roi_mag_belowM_Dz);
    ...
    public void calcCenterS(){
        ...
        center_sx = roi_mag_belowM_xi;
        center_sy = roi_mag_belowM_yi;
        center_sz = roi_mag_belowM_zi;

        // Finding minimum x plane and putting it into center_sx
        for (int i = roi_mag_belowM_xi; i <= roi_mag_belowM_xi + roi_mag_belowM_Dx; i++) {
        ...
        // Finding minimum y plane and putting it into center_sy
        for (int j = roi_mag_belowM_yi; j <= roi_mag_belowM_yi + roi_mag_belowM_Dy; j++) {
        ...
        // Finding minimum z plane and putting it into center_sz
        for (int k = roi_mag_belowM_zi; k <= roi_mag_belowM_zi + roi_mag_belowM_Dz; k++) {
